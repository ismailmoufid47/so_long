...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/23 19:47:50 by isel-mou          #+#    #+#             */
/*   Updated: 2025/02/22 11:43:47 by isel-mou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_filename(char map_char,
	int collectible_count, t_params *params)
{
	if (map_char == 'E' && collectible_count != 0)
		...
		return (get_sprite_filename("textures/opponent_",
...
void	update_sprites(t_params *params)
{
	...
	while (params->map[y])
	{
		...
		while (params->map[y][x])
		{
			...
			filename = get_filename(params->map[y][x],
